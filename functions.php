...
function drawLine($listing) {
    ...
    echo '<td>' . $listing->bathrooms_text . '</td>';
...
function drawTable($listings) {
    ...
    ';
    echo '<tr><th>ID</th><th>Property Name</th><th>Location</th><th>Host</th><th>Accommodates</th><th>Bedrooms</th><th>Bathrooms</th><th>Price</th></tr>
    ';
